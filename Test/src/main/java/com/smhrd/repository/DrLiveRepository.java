...
import com.smhrd.entity.DrLive;
	...
	public interface DrLiveRepository extends JpaRepository<DrLive, Long> {
		...
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Good' AND TIME(d.dl_date) >= :morningStartHour AND TIME(d.dl_date) <= :morningEndHour AND d.dl_id = :dl_id")
		...
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Good' AND TIME(d.dl_date) >= :afternoonStartHour AND TIME(d.dl_date) <= :afternoonEndHour AND d.dl_id = :dl_id")
		...
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Good' AND TIME(d.dl_date) >= :eveningStartHour AND TIME(d.dl_date) <= :eveningEndHour AND d.dl_id = :dl_id")
		...
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Bad' AND TIME(d.dl_date) >= :morningStartHour AND TIME(d.dl_date) <= :morningEndHour AND d.dl_id = :dl_id")
		...
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Bad' AND TIME(d.dl_date) >= :afternoonStartHour AND TIME(d.dl_date) <= :afternoonEndHour AND d.dl_id = :dl_id")
		...
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Bad' AND TIME(d.dl_date) >= :eveningStartHour AND TIME(d.dl_date) <= :eveningEndHour AND d.dl_id = :dl_id")
		...
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Turtle' AND TIME(d.dl_date) >= :morningStartHour AND TIME(d.dl_date) <= :morningEndHour AND d.dl_id = :dl_id")
		...
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Turtle' AND TIME(d.dl_date) >= :afternoonStartHour AND TIME(d.dl_date) <= :afternoonEndHour AND d.dl_id = :dl_id")
		...
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Turtle' AND TIME(d.dl_date) >= :eveningStartHour AND TIME(d.dl_date) <= :eveningEndHour AND d.dl_id = :dl_id")
		...
		// 파이차트 부분
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Good' AND TIME(d.dl_date) >= :StartHour AND TIME(d.dl_date) <= :EndHour AND d.dl_id = :dl_id")
		int findGoodData(@Param("StartHour") String StartHour, @Param("EndHour") String EndHour, @Param("dl_id") String dl_id);
		
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Bad' AND TIME(d.dl_date) >= :StartHour AND TIME(d.dl_date) <= :EndHour AND d.dl_id = :dl_id")
		int findBadData(@Param("StartHour") String StartHour, @Param("EndHour") String EndHour, @Param("dl_id") String dl_id);
		
		@Query("SELECT count(d) FROM DrLive d WHERE d.dl_result = 'Turtle' AND TIME(d.dl_date) >= :StartHour AND TIME(d.dl_date) <= :EndHour AND d.dl_id = :dl_id")
